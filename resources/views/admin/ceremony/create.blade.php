...
@section('content')
    <div class="card">
        ...
        <div class="card-block">
            ...
            @endif
            <form action="{{ route('ceremony.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control form-control-normal" placeholder="" name="birthday">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="datetime-local" class="form-control form-control-normal" placeholder="" name="deathday">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control-normal" placeholder="" name="burail">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="datetime-local" class="form-control form-control-normal" placeholder="" name="burailday" required>
                    </div>
                </div>
