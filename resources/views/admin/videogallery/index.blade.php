                ...
                <table class="table">
                    ...
                    @foreach($videogalleries as $videogallery)
                        <tr>
                            ...
                            <td style="word-break: break-all; white-space: normal; width: 100%;">{{ $videogallery->title }}</td>
                            <td>
                            ...
                            <td>{{ $videogallery->getViews() }}</td>
                            <td>
                                    <a href="{{ route('videogallery.edit', $videogallery->id) }}"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a>

                                    <a href="{{ route('videogallery.destroy', $videogallery->id) }}" ><i class="feather icon-trash-2 f-w-600 f-16 text-c-red"></i></a>
