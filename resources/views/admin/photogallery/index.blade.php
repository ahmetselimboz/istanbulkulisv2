                    ...
                    <tbody>
                        @foreach ($photogalleries as $photogallery)
                            <tr>
                                ...
                                <th scope="row"><a href="{{ route('photogalleryimage.poll', $photogallery->id) }}"> <i
                                            class="feather icon-upload-cloud"></i> </a> </th>
                                <td style="word-break: break-all; white-space: normal; width: 100%;">
                                    {{ $photogallery->title }}</td>
                                <td>
                                ...
                                <td>{{ views($photogallery)->count() }}</td>
                                <td>
                                    <a href="{{ route('photogallery.edit', $photogallery->id) }}"><i
                                            class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></a>

                                    <a href="{{ route('photogallery.destroy', $photogallery->id) }}"><i
