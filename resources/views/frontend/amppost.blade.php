                        ...
                        <div class="col-12">
                            <div class="main-content">
                                ...
                                <div class="info">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="" class="google-follow">
                                                <span>Abone Ol</span>
                                                <amp-img alt="google" src="./assets/img/google-follow.png" width="70" height="23"></amp-img>
                                            </a>
                                        </div>
                                            ...
                                            <ul class="share-menu">
                                                ...
                                                <li>
                                                    <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('frontend.post', ['categoryslug' => str_slug($post->category->name), 'id' => $post->id, 'slug' => $post->slug ]) }}" class="facebook">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 147.01 315"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="cls-1" d="M31.77,315H97V157.41h43.8s4.1-25.43,6.1-53.23H97.29V67.91c0-5.41,7.11-12.69,14.16-12.69H147V0H98.64C30.16,0,31.77,53.08,31.77,61v43.35H0v53H31.77Z"></path></g></g></svg>
                                                    </a>
                                                </li>
                                                <li>
                                ...
                                <div class="similar-news">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-6">
                                                    <a href="{{ route('frontend.amppost', ['categoryslug' => str_slug($post->category->name), 'id' => $post->id, 'slug' => $post->slug ]) }}">
                                                        <amp-img alt="{{$post->title}}" src="{{$post->image}}" width="100" height="63" layout="responsive"></amp-img>
                                                    </a>
                                                </div>
                                                <div class="col-6">
                                                    <ul class="category">
                                                    ...
                                                    <div class="title">
                                                        <a href="{{ route('frontend.amppost', ['categoryslug' => str_slug($post->category->name), 'id' => $post->id, 'slug' => $post->slug ]) }}">{{ $post->title }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            @if($post->keywords)
                                <ul  class="tags">
                                    @foreach(explode(',', $post->keywords) as $key) <li><a href="#">{{ $key }}</a></li>@endforeach
                                </ul>
                            @endif
                        </div>
                            ...
                            <div class="last-news">
                                ...
                                <ul>
                                    @foreach($latestnews as $item)
                                        <li>
                                            <a href="{{ route('frontend.amppost', ['categoryslug' => str_slug($item->category->name), 'id' => $item->id, 'slug' => $item->slug ]) }}">
                                                <div class="image">
                                                    <amp-img alt="{{ $item->title }}" src="{{ $item->image }}" width="100" height="59" layout="responsive"></amp-img>
                                                </div>
                                                <div class="title">
